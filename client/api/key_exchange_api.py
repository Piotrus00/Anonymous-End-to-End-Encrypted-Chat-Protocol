...
def build_key_exchange_frame(session_id: str, public_key_b64: str) -> KeyExchangeFrame:
...
async def send_key_exchange(websocket: Any, session_id: str, public_key_b64: str) -> None:
    frame = build_key_exchange_frame(session_id, public_key_b64)
